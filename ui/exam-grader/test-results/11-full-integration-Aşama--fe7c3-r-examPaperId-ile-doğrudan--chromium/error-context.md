...
- Name: 11-full-integration.spec.ts >> Aşama 9: Öğrenci (METE YILMAZ) Kendi Sonucunu Görüyor >> METE YILMAZ: sonuç detayını gör (examPaperId ile doğrudan)
- Location: e2e\11-full-integration.spec.ts:480:3
